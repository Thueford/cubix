...
Dieses Bild wird im Writeback Kernel des Lens Flare multiplikativ mit den Ghosts und dem Halo kombiniert, bevor diese auf die Ausgangstextur zurückgeschrieben werden (siehe \autoref{img:lfcubix}). Der Lens Flare Effekt ist somit vollständig.
