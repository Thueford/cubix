...
\include{chaptDescription}

\include{chaptCodeDoc}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{creatShader.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth]{shaderMat.png}
\includegraphics[width=0.38\linewidth]{shaderVars.png}
...
\include{sectParticles}

\include{sectPostProc}
